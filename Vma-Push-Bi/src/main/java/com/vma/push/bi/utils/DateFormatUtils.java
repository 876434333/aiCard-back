...
public abstract class DateFormatUtils {
    ...
    public static void main(String[] args) throws Exception {
        //System.out.println(DateFormatUtils.formate(DateFormatUtils.addDay(new Date(), 1),DateFormatUtils.SPLIT_PATTERN_DATE));
        //System.out.println(DateFormatUtils.getIntervalTime(DateFormatUtils.parse("2016-01-07 12:00:00"), DateFormatUtils.parse("2016-01-9 11:00:00")));
    }
