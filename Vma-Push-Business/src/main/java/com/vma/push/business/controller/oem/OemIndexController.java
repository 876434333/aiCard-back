 ...
 */
@RestController
@RequestMapping("/V1.0/oem")
@Api(value = "首页", description = "贴牌商管理后台--首页", tags = {"OemIndexController"})
public class OemIndexController {
    @Autowired
    ...
    public RepCardNumber getCard_number(HttpServletRequest request){
        ...
        String enterpriseId= UserDataUtil.getCustomId(request);
        reqCardNumber.setEnterprise_id(enterpriseId);
