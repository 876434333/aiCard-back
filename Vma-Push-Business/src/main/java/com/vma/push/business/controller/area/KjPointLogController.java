 ...
 */
@RestController(value = "AreaPointLogController")
@RequestMapping("/V1.0")
...
public class KjPointLogController extends ControllerExceptionHandler {
    ...
    @RequestMapping(value = "/area/point/operate", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/area/point/list", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/area/point/sub/list", method = RequestMethod.POST)
    @ApiImplicitParam(name = "reqPiontLogPage",value = "迹点列表",required = true,dataType = "ReqPiontLogPage")
    public RspPage<RspPointLog> pointPage(@RequestBody ReqPiontLogPage reqPiontLogPage, HttpServletRequest request){
        ...
        reqPiontLogPage.setRole(2);
        return kjPointLogService.findPointLogPage(reqPiontLogPage,request);

    }

    @ApiOperation(value = "查询企业迹点详情", notes = "查询企业迹点详情")
    @RequestMapping(value = "/area/point/detail", method = RequestMethod.GET)
...
/*    @ApiOperation(value = "贴牌商详细信息",notes = "贴牌商详细信息")
    @RequestMapping(value = "/area/point/get/{custom_id}",method = RequestMethod.GET)
