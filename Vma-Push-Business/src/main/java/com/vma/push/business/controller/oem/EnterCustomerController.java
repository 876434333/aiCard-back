 ...
 */
@RestController(value = "oemEnterCustomerController")
@RequestMapping("/V1.0")
@Api(value = "客户管理", description = "贴牌商--企业管理", tags = {"EnterCustomerController"})
public class EnterCustomerController {
    ...
    @RequestMapping(value = "/oem/enterprise/list",method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/oem/enterprise/{id}",method = RequestMethod.GET)
