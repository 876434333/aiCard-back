 ...
 */
@RestController(value = "areaAgentCustomerController")
@RequestMapping("/V1.0")
@Api(value = "客户管理", description = "地区总代--代理商管理", tags = {"AgentCustomerController"})
public class AgentCustomerController {
    ...
    @RequestMapping(value = "/area/agent/list",method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/area/agent/{id}",method = RequestMethod.GET)
    @ApiImplicitParam(name = "id",value = "地理商id",required = true,dataType = "String",paramType = "path")
    public RspAgentInfo enterInfo(@PathVariable("id") String id, HttpServletRequest request){
        LOG.info("代理商信息");
    ...
    @RequestMapping(value = "/area/agent/enter/list",method = RequestMethod.POST)
    ...
    @ApiOperation(value = "下级企业列表信息",notes = "下级企业列表信息")
    @RequestMapping(value = "/area/agent/enter/{id}",method = RequestMethod.GET)
    @ApiImplicitParam(name = "id",value = "企业id",required = true,dataType = "String",paramType = "path")
    public RspEnterInfo agentInfo(@PathVariable("id") String id, HttpServletRequest request){
        LOG.info("下级企业列表信息");
    ...
    @RequestMapping(value = "/area/agent",method = RequestMethod.POST)
    ...
    public void oemAdd(@RequestBody ReqAddEnterprise reqEnterList, HttpServletRequest request){
        ...
        String enterprise_no=indexCreate.getIndex("AA","AA");
    ...
    @RequestMapping(value = "/area/agent",method = RequestMethod.PUT)
