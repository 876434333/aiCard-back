 ...
 */
@RestController(value = "AgentPointLogController")
@RequestMapping("/V1.0")
...
public class KjPointLogController extends ControllerExceptionHandler {
    ...
    @RequestMapping(value = "/agent/point/operate", method = RequestMethod.POST)
    ...
    public void add(@RequestBody ReqAddPoint reqAddPoint, HttpServletRequest request){
        ...
        reqAddPoint.setEnterprise_id(Enterprise_id);
    ...
    @RequestMapping(value = "/agent/point/list", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/agent/point/sub/list", method = RequestMethod.POST)
    @ApiImplicitParam(name = "reqPiontLogPage",value = "迹点列表",required = true,dataType = "ReqPiontLogPage")
    public RspPage<RspPointLog> pointPage(@RequestBody ReqPiontLogPage reqPiontLogPage, HttpServletRequest request){
        ...
        reqPiontLogPage.setRole(1);
        return kjPointLogService.findPointLogPage(reqPiontLogPage,request);

    }

    @ApiOperation(value = "查询企业迹点详情", notes = "查询企业迹点详情")
    @RequestMapping(value = "/agent/point/detail", method = RequestMethod.GET)
    public RspPointDetail piontDetail(HttpServletRequest request){
        LOG.info("条件查询迹点列表");
...
//    @RequestMapping(value = "/agent/point/get/{custom_id}",method = RequestMethod.GET)
