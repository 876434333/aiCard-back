...
public class ChineseFCUtil {
	...
	public static void main(String[] args) throws Exception {
		System.out.println(cn2py("1").toUpperCase());
		System.out.println(cn2py("(").toUpperCase());
		System.out.println(cn2py("$").toUpperCase());
		System.out.println(cn2py("e").toUpperCase());
		System.out.println(cn2py("尛").toUpperCase());
	}
